function tls = tritonLogToPampal(tlIn, prefix)
% TRITONLOGTOPAMPAL	Simplify a (collapsed or raw) Triton log for PAMpal
%
%   Syntax:
%       TLS = TRITONLOGTOPAMPAL(TLIN)
%       TLS = TRITONLOGTOPAMPAL(TLIN, PREFIX)
%
%   Description:
%       Simplifies and reshapes a Triton log to the correct formatting for
%       processing with PAMpal into an AcousticStudy object. This reorders
%       and renames columns to be just include start, end, sp (species),
%       and id and it standardizes the datetime format.
%
%       TLIN may be:
...
%       tls = tritonLogToPampal(tlm, 'sg639');
%
%       % raw log, no collapsing, no prefix
%       tls = tritonLogToPampal('E:\sg639_MHI_log_mw.xlsx');
%
