%%%%%%%%%%%% Humpback whales SoCal 2020 Glider SG639 %%%%%%%%%%%%

% timeIncr = 1 / (24*60*60);	% check all detections
% timeIncr = 1;                   % check one detection per day
timeIncr = 1/24;			% check one detection hour


% Sound files and index:
snddir = 'F:\SoCal2020\sg639_downsampled\sg639-5kHz\';
indexpath = [snddir 'file_dates-sg639_SoCal_Feb20-5kHz.txt'];

% Log files:
logdir = 'F:\SoCal2020\largeWhaleAnalysis\Mn\Mn_sg639\';
% inlogpath  = [logdir 'detections_GPL_v2_150_1000_sg607_SOCAL_Feb20_exampleFiles.log'];
inlogpath  = [logdir 'detections_GPL_v2_150_1000_sg639_SOCAL_Feb20_Fdrive.log'];
