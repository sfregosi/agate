...
This package is very much under development, but my hope is that I will maintain a [stable release](https://github.com/sfregosi/agate-public/releases) and then for those interested in the latest functionality, the repository can be cloned.

`r fa(name = "calendar-check")` *Last Update: `r format(Sys.Date(), "%d %b %Y")`*

**Detailed documentation can be found at [sfregosi.github.io/agate-public](https://sfregosi.github.io/agate-public)**
