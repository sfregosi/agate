...
## *Need to convert between WAV and FLAC or downsample your files?*

There are many ways to convert between `.flac` and `.wav` files, and to decimate
to a new sample rate. If you are looking for some simple options, see 
