...
All code on this page combined in the [`workflow_missionTrackPlanning.m`](https://github.com/sfregosi/agate-public/tree/main/agate/example_workflows/workflow_missionTrackPlanning.m) in the `example_workflows` folder within the `agate-public/agate` folder. 
